...
export const SCREENS_WHAT_IS_SOUND: LessonScreen[] = [
  ...
  },
  {
    ...
    options: ["It's too cold", "There is no air for pressure waves to travel through", "Gravity blocks sound waves", "Sound waves travel too slowly"],
    answer: 1,
    explain: "Sound needs a medium (air, water, solid) to travel through. Space is a vacuum — no molecules, no pressure waves, no sound.",
  },
  {
    kind: "quiz",
...
export const SCREENS_FREQUENCY_PITCH: LessonScreen[] = [
  ...
  {
    kind: "quiz",
    q: "Which frequency range is 'sub-bass'?",
    options: ["4,000–8,000 Hz", "250–500 Hz", "20–60 Hz", "1,000–2,000 Hz"],
    answer: 2,
    explain: "Sub-bass lives at 20–60 Hz — you feel it in your chest more than hear it. Think: the lowest part of a 808 kick or a deep synth bass.",
  },
  {
    kind: "summary",
...
export const SCREENS_AMPLITUDE_VOLUME: LessonScreen[] = [
  ...
  {
    kind: "quiz",
    q: "Where should your loudest peaks sit during mixing?",
    options: ["0 dBFS", "+3 dBFS", "Around −6 dBFS", "−60 dBFS"],
    answer: 2,
    explain: "−6 dBFS headroom gives you space for effects, limiting and mastering without clipping. Mixing 'hot' (close to 0) leaves no room and risks distortion.",
  },
  {
    kind: "summary",
...
export const SCREENS_TIMBRE_TONE: LessonScreen[] = [
  ...
  {
    kind: "quiz",
    q: "A sawtooth wave sounds brighter than a sine wave because…",
    options: ["It vibrates faster", "It contains all harmonics (odd and even)", "It has higher amplitude", "It has a slower attack"],
    answer: 1,
    explain: "A sawtooth contains harmonics at every integer multiple of the fundamental. All those overtones add up to a bright, buzzy sound. A sine has zero harmonics — pure tone only.",
  },
  {
    kind: "summary",
...
export const SCREENS_WAVEFORMS: LessonScreen[] = [
  ...
  {
    kind: "quiz",
    q: "A square wave contains which harmonics?",
    options: ["All harmonics (odd + even)", "Odd harmonics only", "Even harmonics only", "No harmonics"],
    answer: 1,
    explain: "Square waves contain the fundamental + odd harmonics (3rd, 5th, 7th…). This gives them a hollow, woody sound — classic for chiptune and organs.",
  },
  {
    kind: "summary",
...
export const SCREENS_SOUND_IN_SPACE: LessonScreen[] = [
  ...
  { kind: "interact", sim: "routing-puzzle", prompt: "Route the signal: Instrument → Reverb → Output" },
  {
    kind: "quiz",
    q: "RT60 measures…",
    options: ["How fast sound travels", "How long reverb takes to decay by 60 dB", "The frequency of room resonance", "The speed of sound at 60°C"],
    answer: 1,
    explain: "RT60 is the standard measure of room reverb: the time in seconds for sound to decay 60 decibels after the source stops. Larger rooms have longer RT60 values.",
  },
  {
    kind: "quiz",
...
export const SCREENS_OVERTONES_HARMONICS: LessonScreen[] = [
  ...
  {
    kind: "quiz",
    q: "If the fundamental is 100 Hz, where is the 3rd harmonic?",
    options: ["200 Hz", "300 Hz", "150 Hz", "400 Hz"],
    answer: 1,
    explain: "Harmonics are at integer multiples: 1st=100 Hz, 2nd=200 Hz, 3rd=300 Hz, 4th=400 Hz. The 3rd harmonic is 3× the fundamental.",
  },
  {
    kind: "quiz",
...
export const SCREENS_HOW_WE_HEAR: LessonScreen[] = [
  ...
  {
    kind: "quiz",
    q: "Why should you mix at a consistent moderate volume?",
    options: ["Loud volumes damage studio monitors", "At extreme volumes, your ear's frequency response changes, making bass and treble seem different", "DAWs perform worse at high volumes", "Neighbours complain"],
    answer: 1,
    explain: "The Fletcher-Munson equal-loudness curves show that bass and treble require more SPL to match the perceived loudness of midrange at low volumes. A 'loud mix' often sounds bass-heavy at normal levels.",
  },
  {
    kind: "summary",
...
export const SCREENS_WHAT_IS_RHYTHM: LessonScreen[] = [
  ...
  {
    kind: "quiz",
    q: "In a 4/4 bar, which beats are typically the 'strong' beats?",
    options: ["Beats 2 and 4", "Beats 1 and 3", "All 4 beats equally", "Beat 1 only"],
    answer: 1,
    explain: "In most Western music, beats 1 and 3 are strong (downbeats). Beats 2 and 4 are weak — which is why snares on 2 and 4 feel so natural in rock and pop.",
  },
  {
    kind: "summary",
...
export const SCREENS_TEMPO_BPM: LessonScreen[] = [
  ...
  {
    kind: "quiz",
    q: "Which genre typically runs at 170–180 BPM?",
    options: ["Deep House", "Hip-Hop", "Drum and Bass", "Reggae"],
    answer: 2,
    explain: "Drum and Bass (D&B) runs at 160–180 BPM. The fast tempo combined with half-time drum patterns (that feel like 80–90 BPM) creates its unique energy.",
  },
  {
    kind: "summary",
...
export const SCREENS_BARS_TIME_SIGNATURES: LessonScreen[] = [
  ...
  {
    kind: "quiz",
    q: "In a 3/4 time signature, how many beats are in each bar?",
    options: ["4", "2", "3", "6"],
    answer: 2,
    explain: "The top number of a time signature tells you the beats per bar. 3/4 = 3 beats per bar. This is the waltz feel — 1-2-3, 1-2-3.",
  },
  {
    kind: "quiz",
...
export const SCREENS_GROOVE_FEEL: LessonScreen[] = [
  ...
  {
    kind: "quiz",
    q: "In a swing groove, what happens to every other 8th note?",
    options: ["It gets louder", "It gets slightly shorter", "It arrives slightly later, creating a lopsided feel", "It plays twice"],
    answer: 2,
    explain: "Swing delays the 'and' eighth notes. Instead of evenly spaced 8ths, you get long-short-long-short. The amount of delay determines how 'swung' the groove sounds.",
  },
  {
    kind: "summary",
...
export const SCREENS_SYNCOPATION: LessonScreen[] = [
  ...
  {
    kind: "quiz",
    q: "A note on the 'and' of beat 2 means it plays…",
    options: ["On beat 2", "Halfway between beat 2 and beat 3", "On beat 3", "Before beat 2"],
    answer: 1,
    explain: "In 4/4 with 8th notes, beat 2 is the 2nd beat. The 'and of 2' is halfway between beat 2 and beat 3. Notation: 1-and-2-AND-3-and-4-and.",
  },
  {
    kind: "summary",
...
export const SCREENS_NOTE_VALUES: LessonScreen[] = [
  ...
  {
    kind: "quiz",
    q: "A dotted quarter note lasts…",
    options: ["1 beat", "1.5 beats", "2 beats", "0.75 beats"],
    answer: 1,
    explain: "A dot adds half the note's value. Quarter = 1 beat. Half of 1 = 0.5. Dotted quarter = 1.5 beats. Dotted notes are common in hip-hop and jazz rhythms.",
  },
  {
    kind: "summary",
...
export const SCREENS_NOTES_AND_OCTAVES: LessonScreen[] = [
  ...
  { kind: "interact", sim: "note-explorer", prompt: "Tap notes on the keyboard — hear pitch change" },
  {
    ...
    options: ["7", "8", "10", "12"],
    answer: 3,
    explain: "One octave = 12 semitones (half-steps). On a piano, count every key (white and black) from one C to the next — that's 12.",
  },
  {
    kind: "quiz",
...
export const SCREENS_MAJOR_SCALE: LessonScreen[] = [
  ...
  {
    kind: "quiz",
    q: "The major scale step pattern is…",
    options: ["W H W W W H W", "W W H W W W H", "H W W H W W W", "W W W H W W H"],
    answer: 1,
    explain: "Major scale: Whole-Whole-Half-Whole-Whole-Whole-Half. Apply this from any root note and you get a major scale in any key.",
  },
  {
    kind: "quiz",
...
export const SCREENS_MINOR_SCALE: LessonScreen[] = [
  ...
  {
    kind: "quiz",
    q: "What makes the minor scale sound 'darker' than major?",
    options: [
      "It uses fewer notes",
      "It plays faster",
      "The 3rd, 6th and 7th are flattened by a semitone",
      "It only uses black keys",
    ],
    answer: 2,
    explain: "The key difference: the minor 3rd (flat 3) is one semitone lower than the major 3rd. This small change creates the characteristic 'dark' or 'sad' quality of minor.",
  },
  {
    kind: "quiz",
...
export const SCREENS_INTERVALS: LessonScreen[] = [
  ...
  {
    kind: "quiz",
    q: "A perfect 5th is how many semitones?",
    options: ["5", "6", "7", "8"],
    answer: 2,
    explain: "Perfect 5th = 7 semitones. C to G is a perfect 5th. It's the most consonant interval after the octave — used in power chords, basslines and chord roots.",
  },
  {
    kind: "quiz",
...
export const SCREENS_EAR_TRAINING: LessonScreen[] = [
  ...
  {
    kind: "quiz",
    q: "Which interval does the opening of 'Star Wars' use?",
    options: ["Minor 3rd", "Tritone", "Perfect 5th", "Major 7th"],
    answer: 2,
    explain: "The famous Star Wars opening uses a perfect 5th (C to G). Hearing this interval and thinking 'Star Wars' is a classic ear training mnemonic.",
  },
  {
    kind: "quiz",
...
export const SCREENS_WHAT_ARE_CHORDS: LessonScreen[] = [
  ...
  {
    kind: "quiz",
    q: "A major triad consists of…",
    options: ["Root + minor 3rd + perfect 5th", "Root + major 3rd + perfect 5th", "Root + 2nd + 4th", "Root + tritone + octave"],
    answer: 1,
    explain: "Major triad: root + major 3rd (4 semitones) + perfect 5th (7 semitones). C major = C + E + G. The major 3rd is what makes it sound 'happy' or 'bright'.",
  },
  {
    kind: "quiz",
...
export const SCREENS_CHORD_PROGRESSIONS: LessonScreen[] = [
  ...
  {
    kind: "quiz",
    q: "In C major, what chord is the V (five)?",
    options: ["F major", "E minor", "G major", "A minor"],
    answer: 2,
    explain: "Count up from C: C(I) D(ii) E(iii) F(IV) G(V). The V chord in C major is G major. The V chord always creates tension that pulls back to the I.",
  },
  {
    kind: "quiz",
...
export const SCREENS_DIGITAL_AUDIO: LessonScreen[] = [
  ...
  {
    kind: "quiz",
    q: "The Nyquist theorem states: to capture a frequency, the sample rate must be…",
    options: ["Equal to that frequency", "At least twice that frequency", "Ten times that frequency", "Half that frequency"],
    answer: 1,
    explain: "Nyquist: sample rate must be at least 2× the highest frequency you want to capture. 44.1 kHz captures frequencies up to 22.05 kHz — just above human hearing range.",
  },
  {
    kind: "summary",
