    ...
    return (
      <main className="min-h-screen bg-ink text-bone flex flex-col justify-center px-6 py-12 max-w-lg mx-auto space-y-8">
        ...
        <div className="space-y-2 font-mono text-sm opacity-70">
          {["5 questions from all 3 worlds", "30 seconds per question or it's wrong", "Speed + accuracy = your score", "Wrong answers cost a heart in CCD mode", "Resets every day at midnight UTC"].map((rule, i) => (
