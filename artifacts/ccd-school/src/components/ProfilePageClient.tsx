    ...
    <main className="min-h-screen bg-bone">
      <header className="brutal-border border-x-0 border-t-0 bg-ink text-bone">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          {user && <div className="font-mono text-sm mt-2 opacity-60">{(user as any).email}</div>}
        </div>
      </header>
        ...
        <section>
          ...
          <div className="space-y-3">
            ...
            <div className="brutal-border p-4">
              ...
              <div className="font-mono text-xs opacity-60 mb-3">Progress is stored locally in your browser. No account needed.</div>
